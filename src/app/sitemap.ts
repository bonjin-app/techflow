...
export default function sitemap(): MetadataRoute.Sitemap {
  const g = getGraph();
  const statics = ["", "/explore", "/map", "/path", "/technology", "/concept", "/pattern", "/architecture", "/compare", "/roadmap", "/system-design", "/search", "/radar", "/stack", "/challenge", "/api-docs", "/playground", "/playground/http", "/playground/cache", "/playground/load-balancer", "/playground/rate-limiter", "/playground/transport", "/playground/jwt"];
